...
export const TeamDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="rosterSampleApplicationApp.team.delete.question">
        <Translate contentKey="rosterSampleApplicationApp.team.delete.question" interpolate={{ id: teamEntity.id }}>
