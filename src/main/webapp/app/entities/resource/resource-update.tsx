  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="rosterSampleApplicationApp.resource.home.createOrEditLabel" data-cy="ResourceCreateUpdateHeading">
            <Translate contentKey="rosterSampleApplicationApp.resource.home.createOrEditLabel">Create or edit a Resource</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('rosterSampleApplicationApp.resource.key')}
                id="resource-key"
                name="key"
                data-cy="key"
                type="text"
              />
              <ValidatedField
                label={translate('rosterSampleApplicationApp.resource.firstName')}
              ...
              />
              <ValidatedField
                label={translate('rosterSampleApplicationApp.resource.lastName')}
              ...
              />
              <ValidatedField
                label={translate('rosterSampleApplicationApp.resource.teamRole')}
              ...
              />
              <ValidatedField
                label={translate('rosterSampleApplicationApp.resource.exchangeAllowed')}
