...
export const ResourceDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="rosterSampleApplicationApp.resource.delete.question">
        <Translate contentKey="rosterSampleApplicationApp.resource.delete.question" interpolate={{ id: resourceEntity.id }}>
