...
export const ShiftDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="rosterSampleApplicationApp.shift.delete.question">
        <Translate contentKey="rosterSampleApplicationApp.shift.delete.question" interpolate={{ id: shiftEntity.id }}>
