  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="rosterSampleApplicationApp.shift.home.createOrEditLabel" data-cy="ShiftCreateUpdateHeading">
            <Translate contentKey="rosterSampleApplicationApp.shift.home.createOrEditLabel">Create or edit a Shift</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('rosterSampleApplicationApp.shift.key')}
                id="shift-key"
                name="key"
                data-cy="key"
                type="text"
              />
              <ValidatedField
                label={translate('rosterSampleApplicationApp.shift.shiftStart')}
                id="shift-shiftStart"
                name="shiftStart"
                data-cy="shiftStart"
                type="datetime-local"
              ...
              />
              <ValidatedField
                label={translate('rosterSampleApplicationApp.shift.shiftEnd')}
                id="shift-shiftEnd"
                name="shiftEnd"
                data-cy="shiftEnd"
                type="datetime-local"
              ...
              />
              <ValidatedField
                label={translate('rosterSampleApplicationApp.shift.type')}
                id="shift-type"
                name="type"
                data-cy="type"
                type="text"
