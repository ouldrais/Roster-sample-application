...
export const ResourceTrainingDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="rosterSampleApplicationApp.resourceTraining.delete.question">
        <Translate contentKey="rosterSampleApplicationApp.resourceTraining.delete.question" interpolate={{ id: resourceTrainingEntity.id }}>
