...
export const DepartmentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="rosterSampleApplicationApp.department.delete.question">
        <Translate contentKey="rosterSampleApplicationApp.department.delete.question" interpolate={{ id: departmentEntity.id }}>
