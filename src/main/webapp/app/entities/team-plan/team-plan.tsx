  ...
  return (
    <div>
      <h2 id="team-plan-heading" data-cy="TeamPlanHeading">
        <Translate contentKey="rosterSampleApplicationApp.teamPlan.home.title">Team Plans</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="rosterSampleApplicationApp.teamPlan.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/team-plan/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="rosterSampleApplicationApp.teamPlan.home.createLabel">Create new Team Plan</Translate>
          </Link>
        </div>
      </h2>
        ...
        {teamPlanList && teamPlanList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="rosterSampleApplicationApp.teamPlan.id">ID</Translate>{' '}
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="rosterSampleApplicationApp.teamPlan.home.notFound">No Team Plans found</Translate>
            </div>
          )
        )}
      </div>
