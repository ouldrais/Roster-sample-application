...
export const TeamPlanDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="rosterSampleApplicationApp.teamPlan.delete.question">
        <Translate contentKey="rosterSampleApplicationApp.teamPlan.delete.question" interpolate={{ id: teamPlanEntity.id }}>
