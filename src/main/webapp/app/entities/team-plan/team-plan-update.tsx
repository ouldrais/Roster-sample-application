  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="rosterSampleApplicationApp.teamPlan.home.createOrEditLabel" data-cy="TeamPlanCreateUpdateHeading">
            <Translate contentKey="rosterSampleApplicationApp.teamPlan.home.createOrEditLabel">Create or edit a TeamPlan</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('rosterSampleApplicationApp.teamPlan.availability')}
