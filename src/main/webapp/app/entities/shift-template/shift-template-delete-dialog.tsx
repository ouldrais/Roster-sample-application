...
export const ShiftTemplateDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="rosterSampleApplicationApp.shiftTemplate.delete.question">
        <Translate contentKey="rosterSampleApplicationApp.shiftTemplate.delete.question" interpolate={{ id: shiftTemplateEntity.id }}>
