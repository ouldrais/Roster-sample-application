  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="rosterSampleApplicationApp.shiftTemplate.home.createOrEditLabel" data-cy="ShiftTemplateCreateUpdateHeading">
            <Translate contentKey="rosterSampleApplicationApp.shiftTemplate.home.createOrEditLabel">
              Create or edit a ShiftTemplate
            </Translate>
          </h2>
        </Col>
      </Row>
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('rosterSampleApplicationApp.shiftTemplate.key')}
              ...
              />
              <ValidatedField
                label={translate('rosterSampleApplicationApp.shiftTemplate.shiftStart')}
              ...
              />
              <ValidatedField
                label={translate('rosterSampleApplicationApp.shiftTemplate.shiftEnd')}
              ...
              />
              <ValidatedField
                label={translate('rosterSampleApplicationApp.shiftTemplate.type')}
