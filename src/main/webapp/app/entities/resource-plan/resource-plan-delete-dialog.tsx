...
export const ResourcePlanDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="rosterSampleApplicationApp.resourcePlan.delete.question">
        <Translate contentKey="rosterSampleApplicationApp.resourcePlan.delete.question" interpolate={{ id: resourcePlanEntity.id }}>
