  ...
  return (
    <div>
      <h2 id="resource-plan-heading" data-cy="ResourcePlanHeading">
        <Translate contentKey="rosterSampleApplicationApp.resourcePlan.home.title">Resource Plans</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="rosterSampleApplicationApp.resourcePlan.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/resource-plan/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="rosterSampleApplicationApp.resourcePlan.home.createLabel">Create new Resource Plan</Translate>
          </Link>
        </div>
      </h2>
        ...
        {resourcePlanList && resourcePlanList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="rosterSampleApplicationApp.resourcePlan.id">ID</Translate>{' '}
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="rosterSampleApplicationApp.resourcePlan.home.notFound">No Resource Plans found</Translate>
            </div>
          )
        )}
      </div>
