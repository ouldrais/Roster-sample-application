  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="rosterSampleApplicationApp.resourcePlan.home.createOrEditLabel" data-cy="ResourcePlanCreateUpdateHeading">
            <Translate contentKey="rosterSampleApplicationApp.resourcePlan.home.createOrEditLabel">Create or edit a ResourcePlan</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('rosterSampleApplicationApp.resourcePlan.availability')}
              ...
              <ValidatedField
                ...
                name="resource"
                data-cy="resource"
                label={translate('rosterSampleApplicationApp.resourcePlan.resource')}
                type="select"
              >
                <option value="" key="0" />
                {resources
              ...
              <ValidatedField
                ...
                name="shift"
                data-cy="shift"
                label={translate('rosterSampleApplicationApp.resourcePlan.shift')}
                type="select"
              >
                <option value="" key="0" />
                {shifts
              ...
              <ValidatedField
                ...
                name="position"
                data-cy="position"
                label={translate('rosterSampleApplicationApp.resourcePlan.position')}
                type="select"
              >
                <option value="" key="0" />
                {positions
