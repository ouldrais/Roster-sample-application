  ...
  return (
    <div>
      <h2 id="position-requirement-heading" data-cy="PositionRequirementHeading">
        <Translate contentKey="rosterSampleApplicationApp.positionRequirement.home.title">Position Requirements</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="rosterSampleApplicationApp.positionRequirement.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link
          ...
          >
            ...
            &nbsp;
            <Translate contentKey="rosterSampleApplicationApp.positionRequirement.home.createLabel">
        ...
        {positionRequirementList && positionRequirementList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="rosterSampleApplicationApp.positionRequirement.id">ID</Translate>{' '}
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="rosterSampleApplicationApp.positionRequirement.home.notFound">
                No Position Requirements found
              </Translate>
            </div>
          )
        )}
