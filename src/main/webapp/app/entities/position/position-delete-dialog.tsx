...
export const PositionDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="rosterSampleApplicationApp.position.delete.question">
        <Translate contentKey="rosterSampleApplicationApp.position.delete.question" interpolate={{ id: positionEntity.id }}>
