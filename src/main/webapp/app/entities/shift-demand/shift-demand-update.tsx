  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="rosterSampleApplicationApp.shiftDemand.home.createOrEditLabel" data-cy="ShiftDemandCreateUpdateHeading">
            <Translate contentKey="rosterSampleApplicationApp.shiftDemand.home.createOrEditLabel">Create or edit a ShiftDemand</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('rosterSampleApplicationApp.shiftDemand.count')}
