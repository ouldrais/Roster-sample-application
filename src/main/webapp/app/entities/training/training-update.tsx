  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="rosterSampleApplicationApp.training.home.createOrEditLabel" data-cy="TrainingCreateUpdateHeading">
            <Translate contentKey="rosterSampleApplicationApp.training.home.createOrEditLabel">Create or edit a Training</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('rosterSampleApplicationApp.training.key')}
                id="training-key"
                name="key"
                data-cy="key"
                type="text"
              />
              <ValidatedField
                label={translate('rosterSampleApplicationApp.training.description')}
