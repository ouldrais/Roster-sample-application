...
class PositionResourceIT {
    ...
    private static final String DEFAULT_LEADERSHIP = "AAAAAAAAAA";
    private static final String UPDATED_LEADERSHIP = "BBBBBBBBBB";
    ...
    public static Position createEntity(EntityManager em) {
        Position position = new Position().key(DEFAULT_KEY).leadership(DEFAULT_LEADERSHIP);
        return position;
    }
    ...
    public static Position createUpdatedEntity(EntityManager em) {
        Position position = new Position().key(UPDATED_KEY).leadership(UPDATED_LEADERSHIP);
        return position;
    }
    ...
    void createPosition() throws Exception {
        ...
        assertThat(testPosition.getKey()).isEqualTo(DEFAULT_KEY);
        assertThat(testPosition.getLeadership()).isEqualTo(DEFAULT_LEADERSHIP);
    }
    ...
    void putExistingPosition() throws Exception {
        ...
        updatedPosition.key(UPDATED_KEY).leadership(UPDATED_LEADERSHIP);
        ...
        Position testPosition = positionList.get(positionList.size() - 1);
        assertThat(testPosition.getKey()).isEqualTo(UPDATED_KEY);
        assertThat(testPosition.getLeadership()).isEqualTo(UPDATED_LEADERSHIP);
    }
    ...
    void partialUpdatePositionWithPatch() throws Exception {
        ...
        partialUpdatedPosition.key(UPDATED_KEY);
    ...
    void fullUpdatePositionWithPatch() throws Exception {
        ...
        partialUpdatedPosition.key(UPDATED_KEY).leadership(UPDATED_LEADERSHIP);
